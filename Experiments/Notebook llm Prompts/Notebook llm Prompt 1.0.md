...
Complex Terms Rule:
Before using any technical word (for example: inflation, ECB, BOE, interest rates, GDP), briefly explain it in one sentence using plain language, then continue the explanation normally.
