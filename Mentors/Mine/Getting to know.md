...
- My Family Behaviours, i end up observing them even if i don't want to, such as observing family financial conditions / family member moods etc.

### Questions You Obsess Over

Some questions matter, but their answers lead to the same direction regardless.

For example, I may have three different questions about the full map from A to Z, but it is obvious that I must first achieve A before worrying about those questions.

I can delay them until I reach that point. example -- i wonder is it correct to chase greatness or shoould i just enjoy my life as a rich guy, conclusion i need to be rich first in both scenarios.

### Things You Can't Stop Analyzing

1. **Trading Strategy Improvement**
    
    - I think my trading strategy needs improvement.
    - Not the fake version of it, but a well-written, rule-based strategy where:
        - I know the win rate on paper.
        - I know my execution quality.
        - My entire strategy is written down and measurable.
2. **The Slow Path**
    
    - Sometimes I think I would have gone further in certain skills if I had followed the slow path.
    - Instead of trying to place 10 bricks at a time, I should have focused on placing 1 brick at a time and stacking them consistently.

---

## What I Repeatedly Feel

### Patterns

**Unease While Backtesting**

- While backtesting, I experience a sense of unease that eventually causes me to quit doing it, even though i enjoy doing it.

**Happiness While Trading / Backtesting / Thinking Freely**
...
> "The Past Exists through memories , the future is your imagination only the present is what you have "
> 
> > The past exists through memories means that memories of every creature not just yours , because if something happened in the past that everyone remembers and you forget , the past still exists through memories ,  but if everyone forget  , the past crumbles. 
> 
...
**Interesting Counterpoint:** If everyone forgets a tree fell in your forest, did it not fall? (Solved)

---
>> > Alex Hormozi( Improved version):  " Most people overestimate what they can achieve in a short period of time and underestimate what they can achieve over a longer period of time. "
...
**Theory 1 - Pullback Confirmation Methods**

1. Way 1 -- Confirming a Pullback with [0.382 fib level].
2. Way 2 -- Confirming a Pullback with the a trend shift in internal Structure.
3. Way 3 -- Confirming a Pullback with [0.278 fib level , 27.8%]

_Which gives the best bias overall: Way 1, Way 2, or both combined?_

**Theory 2 - Structure Identification Limits**
...
**Theory 3 - Profit Taking Strategy**
...
- Which gives the best bias overall: Way 1, Way 2,Way 3 or both combined?
- Is L2 The limit of structure identification? Since beyond L2 I don't know what timeframe closing to look for?
- Which is more beneficial: Taking Profit at weak Highs/lows or Taking Profit at fix 1:3 R:R?
...
(To be filled as you verify strategies)
